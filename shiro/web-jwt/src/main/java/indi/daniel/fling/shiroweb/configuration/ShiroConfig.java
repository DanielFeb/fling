package indi.daniel.fling.shiroweb.configuration;

import indi.daniel.fling.shiroweb.filter.AnyRolesAuthorizationFilter;
import indi.daniel.fling.shiroweb.filter.JwtAuthFilter;
